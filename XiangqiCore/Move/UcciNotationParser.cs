...
public class UcciNotationParser : MoveNotationBase
{
    ...
    private Coordinate ParseUcciCoordinate(string ucciCoordinate)
    {
        ...
        return new Coordinate(TranslateUcciColumn(ucciColumn), TranslateUcciRow(ucciRow));
    }
    ...
    private int TranslateUcciColumn(char ucciColumn) => UcciColumnMap[ucciColumn];
    private int TranslateUcciRow(int ucciRow) => UcciRowMap[ucciRow];
