...
public static class XiangqiBuilderTests
{
	...
	public static async Task ShouldCreateGameNameAutomatically_WhenDetailsNotProvidedAsync(string redPlayerName, string blackPlayerName, GameResult gameResult, string expectedGameName)
	{
		// Arrange
		XiangqiBuilder builder = new();
